...
} from "../../../contracts/smartWallet/SmartWallet";
...
const _abi = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "address",
        name: "v2pancakeFactory",
        type: "address",
      },
      {
        internalType: "address",
        name: "v3pancakeFactory",
        type: "address",
      },
    ],
    name: "exec",
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum PriceHelper.TradeRoute",
        name: "route",
        type: "uint8",
      },
      {
    ...
    inputs: [
      {
        ...
        internalType: "struct IWallet.TokenSpenderPair[]",
        name: "approvals",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        name: "gasCostInNative",
        type: "uint128",
      },
    ],
    name: "quoteGasFeeInAsset",
    outputs: [
      {
        internalType: "uint256",
        name: "",

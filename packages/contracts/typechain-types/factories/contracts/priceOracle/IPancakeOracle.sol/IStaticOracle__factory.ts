...
} from "../../../../contracts/priceOracle/IPancakeOracle.sol/IStaticOracle";
...
export class IStaticOracle__factory {
  ...
  static createInterface(): IStaticOracleInterface {
    return new utils.Interface(_abi) as IStaticOracleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IStaticOracle {
    return new Contract(address, _abi, signerOrProvider) as IStaticOracle;
  }
}

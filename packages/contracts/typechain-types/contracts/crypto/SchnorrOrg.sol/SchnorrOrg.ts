...
export interface SchnorrOrgInterface extends utils.Interface {
  functions: {
    ...
    "n()": FunctionFragment;
    "neg(uint256,uint256)": FunctionFragment;
    "p()": FunctionFragment;
...
export interface SchnorrOrg extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SchnorrOrgInterface;
  ...
  functions: {
    ...
    neg(
      val: PromiseOrValue<BigNumberish>,
      val2: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber, BigNumber]>;

...
export interface ECDSAWalletStateInterface extends utils.Interface {
  functions: {
...
export interface ECDSAWalletState extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ECDSAWalletStateInterface;
